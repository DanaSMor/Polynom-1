...
public class Polynom implements Polynom_able
{
	 ...
	 * Polynom from the format a*x^b + a*x^b - a*x^b....
	 ...
	 * We used: https://en.wikipedia.org/wiki/Riemann_integral
	...
	/**
	 * This function create a String of this Polynom.
	 * The function uses a iterator that goes over all the Polynom and uses the toString of each Monom.
