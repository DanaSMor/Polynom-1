 ...
 * number and a is an integer (summed a none negative), The class implements
 * function and support simdple operations as: construction, value at x,
 * derivative, add and multiply. see: https://en.wikipedia.org/wiki/Monomial
 * 
...
public class Monom implements function {
	...
	/**
	 * A constractor that gets a string Monoms from the format a*x^b / ax / a / x /
	 * x^b when a is a decimal number that represent the coefficient, and b is a
	 * natural (not negative) number that represent the power.
	 * 
	...
	/**
	 * This function add a new monom to our monom , if they have the same power
	 * otherwise its print error messege
	 * 
	...
	/**
	 * the fanction multiplyed our monom by a new monom ( after multiplying our
	 * monom data will be change to the multiplyed monom)
	 * 
